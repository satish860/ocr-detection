...
from ocr_detection.detector import AnalysisResult, PageType, PDFAnalyzer
...
class TestParallelProcessing:
    ...
    def test_worker_count_determination(self, mock_cpu_count):
        ...
        with self.analyzer, patch("ocr_detection.detector.ThreadPoolExecutor") as mock_executor:
